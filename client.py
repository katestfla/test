...
@carltongibson
carltongibson Fixed #32159 -- Ensured AsyncRequestFactory correctly sets headers.
Latest commit ebb08d1 on Nov 4, 2020
 History
 77 contributors
@freakboy3742@aaugustin@claudep@jdufresne@timgraham@malcolmt@jacobian@gdub@ramiro@desecho@adrianholovaty@spookylukey
926 lines (818 sloc)  36.4 KB
...
class AsyncClientHandler(BaseHandler):
    """AsyncClientHandler is a handler of AsyncClient."""
    def __init__(self, enforce_csrf_checks=True, *args, **kwargs):
        self.enforce_csrf_checks = enforce_csrf_checks
        super().__init__(*args, **kwargs)
